...
class Feb_model extends CI_model{
	public function getFebruari()
	{
 		...
 		$sql = "SELECT t_rak_belanja.nm_skpd, SUM(t_rak_belanja.bulan2) AS anggaran, SUM(t_realisasi_rekening_belanja.nilai_realisasi) AS realisasi 
 		FROM t_rak_belanja
 		...
 		WHERE t_realisasi_rekening_belanja.bulan_dok = 'Feb'
