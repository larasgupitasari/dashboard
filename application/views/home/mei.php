...
<script>
    ...
    title: {
        text: 'Realisasi Anggaran Belanja Bulan Mei (%)'
    },
    tooltip: {
...
<script>
	Highcharts.chart('barChart', {
	    ...
	    title: {
	        text: 'Penyerapan Anggaran Bulan Mei 2022'
	    },
	    xAxis: {
	        type: 'category',
	        labels: {
	    ...
	    series: [{
	        name: 'SKPD',
	        data: [
							<?php foreach ($Mei as $m){
						     	$nama = (string) $m['nm_skpd'];
							   	$prs = (float) number_format(($m['realisasi']/$m['anggaran']*100), 2, '.', '');
							   	$data = [$nama,$prs];
...
<div class="container" style="margin-top: 55px">
	<div class="card mt-5">
		<div class="card-body">
			<h4>Realisasi Belanja Seluruh SKPD Berdasarkan Anggaran Kas Bulan Mei</h4>
			<br>
	          	...
	          	<tbody>
					<?php
		            	...
		            	foreach ($Mei as $m): ?>
			              ...
			              <td><?php echo $no++;?>.</td>
			              <td><?= $m['nm_skpd']; ?></td>
			              <td>Rp.<?= number_format(($m['anggaran']), 0, ',','.'); ?></td>
			              <td>Rp.<?= number_format(($m['realisasi']), 0, ',','.'); ?></td>
			              <td><?php echo number_format(($m['realisasi']/$m['anggaran']*100), 2, ',', ''); ?>%</td>
			         	  </tr>
			         	<?php endforeach; ?>
	      		</tbody>
	  		</table>
