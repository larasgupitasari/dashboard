...
<script>
    ...
    title: {
        text: 'Realisasi Anggaran Belanja Bulan April (%)'
    },
    tooltip: {
...
<script>
	Highcharts.chart('barChart', {
	    ...
	    title: {
	        text: 'Penyerapan Anggaran Bulan April 2022'
	    },
	    xAxis: {
	        type: 'category',
	        labels: {
	    ...
	    series: [{
	        name: 'SKPD',
	        data: [
							<?php foreach ($April as $apr){
						     	$nama = (string) $apr['nm_skpd'];
							   	$prs = (float) number_format(($apr['realisasi']/$apr['anggaran']*100), 2, '.', '');
							   	$data = [$nama,$prs];
...
<div class="container" style="margin-top: 55px">
	<div class="card mt-5">
		<div class="card-body">
			<h4>Realisasi Belanja Seluruh SKPD Berdasarkan Anggaran Kas Bulan April</h4>
			<br>
	          	...
	          	<tbody>
					<?php
		            	...
		            	foreach ($April as $apr): ?>
			              ...
			              <td><?php echo $no++;?>.</td>
			              <td><?= $apr['nm_skpd']; ?></td>
			              <td>Rp.<?= number_format(($apr['anggaran']), 0, ',','.'); ?></td>
			              <td>Rp.<?= number_format(($apr['realisasi']), 0, ',','.'); ?></td>
			              <td><?php echo number_format(($apr['realisasi']/$apr['anggaran']*100), 2, ',', ''); ?>%</td>
			         	  </tr>
			         	<?php endforeach; ?>
	      		</tbody>
	  		</table>
